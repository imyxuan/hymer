...
class MultilingualTest extends TestCase
{
    public function setUp(): void
    {
        ...
        config()->set('hymer.multilingual.locales', ['en', 'da']);

        // Turn on multilingual
        config()->set('hymer.multilingual.enabled', true);
    }

    public function testCheckingModelIsTranslatable()
    {
        $this->assertTrue(Hymer::translatable(TranslatableModel::class));
        $this->assertTrue(Hymer::translatable(ActuallyTranslatableModel::class));
    }

    public function testCheckingModelIsNotTranslatable()
    {
        $this->assertFalse(Hymer::translatable(NotTranslatableModel::class));
        $this->assertFalse(Hymer::translatable(StillNotTranslatableModel::class));
    }
