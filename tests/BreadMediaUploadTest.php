...
class BreadMediaUploadTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->storage = Storage::disk(config('hymer.storage.disk'));
    }
    ...
    public function testMultipleImagesDelete()
    {
        ...
        $response = $this->post(route('hymer.pages.media.remove'), [
            'id'        => $page->id,
            'slug'      => 'pages',
            'field'     => 'image',
            'multi'     => 'true',
    ...
    public function testFileDelete()
    {
        ...
        $this->call('POST', route('hymer.pages.media.remove'), [
            'id'        => $page->id,
            'slug'      => 'pages',
            'field'     => 'image',
            'multi'     => 'true',
    ...
    public function testUploadSecondFile()
    {
        ...
        $this->call('PUT', route('hymer.pages.update', $page->id), [
