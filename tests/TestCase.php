...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup Hymer configuration
        $app['config']->set('hymer.user.namespace', User::class);
    ...
    {
        $this->artisan('hymer:install', ['--with-dummy' => $this->withDummy]);

        app(HymerServiceProvider::class, ['app' => $this->app])->loadAuth();
