...
return [
    'welcome'                => 'Welcome to the Hymer Compass. Every good app needs a compass to point them in the right direction.
    ...
    'links'         => [
        ...
        'hymer_homepage'      => 'Hymer Homepage',
    ],
    'commands'      => [
        'title'                 => 'Commands',
        'text'                  => 'Run Artisan Commands from Hymer.',
    ...
    'resources'     => [
        'title'                 => 'Resources',
        'text'                  => 'Hymer resources to help you find things quicker.',
    ...
    'fonts'         => [
        'title'                 => 'Fonts',
        'font_class'            => 'Hymer Fonts Class Mapping',
        'font_character'        => 'Hymer Fonts Character Mapping',
    ],
];
