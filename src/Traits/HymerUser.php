...
trait HymerUser
{
    ...
    {
        return $this->belongsTo(Hymer::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(Hymer::modelClass('Role'), 'user_roles', 'user_id', 'role_id');
    }
    ...
    {
        $role = Hymer::model('Role')->where('name', '=', $name)->first();
